...
@Component({
  selector: 'app-shopsrequest',
  templateUrl: './shopsrequest.component.html',
  styleUrls: ['./shopsrequest.component.css']
})
export class ShopsrequestComponent implements OnInit {
  closeResult: string;
  displayedColumns: string[] = ['serial_no', 'name','id','email','contact','frachise','message','status','action'];
