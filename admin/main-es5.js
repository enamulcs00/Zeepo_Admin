(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
          ...
          value: function intercept(request, next) {
            ...
            return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (data) {
              ...
              if (data.body && data.body.code == 400) {
                _this.commonService.openDialog('error', data.body.message);
              ...
              if (((_a = err.error) === null || _a === void 0 ? void 0 : _a.data) != null && ((_b = err.error) === null || _b === void 0 ? void 0 : _b.data) != undefined) {
                if (typeof err.error.data == 'object') {
                  ...
                  if (errr != '') {
                    _this.commonService.openDialog('error', errr);
                  }
                }
              } else {
                ...
                _this.commonService.openDialog('error', error);
              }

              if (err.status === 401) {
                _this.commonService.openDialog('error', 'Not authorized');
      ...
      var Approutes = [{
        ...
        // { path: 'maps', loadChildren: () => import('./maps/maps.module').then(m => m.MapsModule) },
        {
          ...
          loadChildren: function loadChildren() {
            ...
            [__webpack_require__.e("default~dashboards-dashboard-module~pages-pages-module"), __webpack_require__.e("common"), __webpack_require__.e("pages-pages-module")]).then(__webpack_require__.bind(null,
            /*! ./pages/pages.module */
    ...
    function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_http_api_list__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
      ...
      var src_app_jwt_jwt_interceptor__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! src/app/_jwt/jwt.interceptor */
      "./src/app/_jwt/jwt.interceptor.ts");
      /* harmony import */


      var src_app_jwt_error_interceptor__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({
        ...
        //     multi: true },
        {
          ...
          useClass: src_app_jwt_error_interceptor__WEBPACK_IMPORTED_MODULE_26__["ErrorInterceptor"],
          multi: true
        }, {
          provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"],
          useClass: src_app_jwt_jwt_interceptor__WEBPACK_IMPORTED_MODULE_25__["JwtInterceptor"],
          multi: true
        ...
        }), _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_10__["DragDropModule"], ngx_spinner__WEBPACK_IMPORTED_MODULE_24__["NgxSpinnerModule"]]]
      });
    ...
    function srcAppSharedHeaderNavigationNavigationComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var NavigationComponent = /*#__PURE__*/function () {
        function NavigationComponent(modalService, router) {
        ...
        _createClass(NavigationComponent, [{
          ...
          value: function logout() {
            ...
            localStorage.clear(); // this.router.navigate(['/authentication/login']);
